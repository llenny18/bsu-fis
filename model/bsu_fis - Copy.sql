...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 28, 2025 at 08:25 AM
...
(22, '43534', 'saved', '2025-01-28 16:00:00');
...
(22, 830583, 'Masters', '8978978', '789', '78978', '1918', 78978),
(23, 65004, 'Masters', '12', '1212', '121', '1915', 1212);
...
(65004, '12121', 'b0RFTCs0NDRNQjVxc0V5NE9qZGF3Zz09OjrOY1cp8B4dbNfkf0Fqsc/P', '121', '212', '1212', 'Female', 23, '2002-01-02', '121', 'Divorced', '09674826333', '67867@email.com', 'non-teaching', 'saved'),
(830583, '78978', 'bEdackk4ODFWa0lJeFJtNHAwRHJMZz09OjoA1VJlUByQ1IN1gb4JrLFX', '789', '78978', '978978', 'Female', 23, '2002-01-08', '789', 'Married', '09623758322', '97897@email.com', 'teaching', 'saved');
...
(70, NULL, 65, '45345', '34534', 'Partially Met', '2025-01-09 07:05:00', 'saved'),
(71, NULL, 70, '5345', '534', 'Ongoing', '2025-01-07 07:05:00', 'saved'),
(72, NULL, 76, '345', '345', 'Partially Met', '2025-02-01 07:05:00', 'saved');
...
(3, 3, 'Upgrade Clinics', 'Number of clinics upgraded', 'Healthcare Department', 'Target 1: 10 clinics', 'Target 2: 15 clinics', 'Target 3: 20 clinics', 'Target 4: 25 clinics', 30000.00, 'Health Ministry', 'Construction delays', 'High', 'Secure early contractors', '2024-11-11 10:21:16', 'archived'),
...
(57, 1, 'Skills Development Programs', 'Number of people trained', 'Labor and Employment Office', 'Target 1: 500 people', 'Target 2: 600 people', 'Target 3: 700 people', 'Target 4: 800 people', 24000.00, 'Government', 'Inadequate training resources', 'Moderate', 'Partner with training providers', '2024-12-23 10:21:16', 'archived'),
...
(61, 3, 'Upgrade Hospitals', 'Number of hospitals upgraded', 'Healthcare Department', 'Target 1: 5 hospitals', 'Target 2: 10 hospitals', 'Target 3: 15 hospitals', 'Target 4: 20 hospitals', 40000.00, 'Health Ministry', 'Supply chain disruptions', 'High', 'Source from multiple suppliers', '2024-05-10 02:21:16', 'archived'),
...
(84, 1, 'Small Business Grants', '213', '12312', '213', '12312', '21', '213', 123.00, '12', '213', '12312', '3123', '2025-01-27 07:20:16', 'saved'),
(85, 1, 'Small Business Grants', '435345', '345', '534', '345', '34534', '5345', 345.00, '345', '435', '34545', '345', '2025-01-27 07:20:16', 'saved');
...
(13, 830583, 78978, 789789, 'General', '789', '789', 97878);
...
(10, 830583, '2025-02-01', 789, 'Full Time', 'Permanent', 'Professor II', '789', 8978.00),
(11, 65004, '2025-01-23', 12, 'Full Time', 'Temporary', 'Associate Professor III', '121212', 1212.00);
...
CREATE  VIEW `count_by_remarks`  AS SELECT `operational_plan_view`.`remarks` AS `remarks`, count(0) AS `remark_count` FROM `operational_plan_view` GROUP BY `operational_plan_view`.`remarks` ORDER BY count(0) DESC ;
...
CREATE  VIEW `month_year_costs`  AS SELECT date_format(`pap`.`date_time`,'%M %Y') AS `month_year`, sum(`pap`.`total_estimated_cost`) AS `total_estimated_cost` FROM `pap` GROUP BY year(`pap`.`date_time`), month(`pap`.`date_time`) ORDER BY year(`pap`.`date_time`) DESC, month(`pap`.`date_time`) DESC ;
...
CREATE  VIEW `operational_plan_quarterly_sums`  AS SELECT sum(`p`.`quarterly_target_q1`) AS `total_q1`, sum(`p`.`quarterly_target_q2`) AS `total_q2`, sum(`p`.`quarterly_target_q3`) AS `total_q3`, sum(`p`.`quarterly_target_q4`) AS `total_q4` FROM `operational_plan_full` AS `p` ;
...
CREATE  VIEW `total_cost_per_area`  AS SELECT `operational_plan_full`.`development_area_name` AS `development_area_name`, sum(`operational_plan_full`.`total_estimated_cost`) AS `total_cost` FROM `operational_plan_full` GROUP BY `operational_plan_full`.`development_area_name` ;
...
--
ALTER TABLE `employee_accounts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=830584;
