...
<body>
    ...
    <select id="column-select" class="form-control d-inline-block w-auto">
        ...
        <option value="0">Program / Activity / Project</option>
        <option value="1">Performance Indicator</option>
        <option value="2">Personnel / Office Concerned</option>
        <option value="3">Q1</option>
        <option value="4">Q2</option>
        <option value="5">Q3</option>
        <option value="6">Q4</option>
        <option value="7">Total Estimated Cost</option>
        <option value="8">Funding Source</option>
        <option value="9">Risks</option>
        <option value="10">Assessment of Risk</option>
        <option value="11">Mitigating Activities</option>
...
<table  style="color: #2e2d2d;"   class="table table-bordered " id="opmm-table">
   ...
   function countPAPRows($data, $papName)
   {
    ...
    foreach ($data as $row) {
        ...
        echo "<td style='display: none'>" . htmlspecialchars($row['m_year']) . "</td>";
