...
if(isset($_POST['edit_matrix'])){
    ...
    $m_id = $_POST['m_id']; // The new username
...
function editST(button) {
 ...
 function editRow(button) {
            ...
            // Replace the current row values with input fields
            row.cells[0].innerHTML = `<input type="text" name="m_id" class="form-control" style="width: 300px; display: inline-block; border: 1px solid darkred;"  value="${cell1}">`;
            ...
            row.cells[7].innerHTML = `<input type="text" name="remarks" class="form-control" style="width: 300px; display: inline-block; border: 1px solid darkred;" value="${cell6}">`;
