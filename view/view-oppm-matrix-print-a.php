...
?>
    ...
    <select id="column-select" class="form-control d-inline-block w-auto">
        <option value="">Select Column</option>
        <option value="0">Outcomes</option>
        <option value="1">Strategy/ies</option>
        <option value="2">Action Step/Program, Activities, Projects (PAPs)</option>
        <option value="3">Performance Indicator</option>
        <option value="4">Actual Accomplishments</option>
        <option value="5">Variance</option>
        <option value="6">Remarks</option>
        <option value="7">Year</option>
    </select>
    <input type="text" id="filter-input" class="form-control d-inline-block w-auto" placeholder="Enter value to search">
</div>
<hr>
                                        ...
                                        <th >Remarks</th>
                                            ...
                                            foreach ($data as $row) {
                                                ...
                                                echo "<tr>
                                                    ...
                                                    <td>" . htmlspecialchars($row['actual_accomplishments'] ?? "NA") . "</td>
                                                    <td>" . htmlspecialchars($row['variance'] ?? "NA") . "</td>
                                                    <td>" . htmlspecialchars($row['remarks'] ?? "NA") . "</td>
                                                    <td style='display:none;'> " . htmlspecialchars($row['m_year'] ?? "NA") . "</td>";
...
window.location.reload();
  ...
  <script>
    document.addEventListener("DOMContentLoaded", () => {
        ...
        const table = document.getElementById("opmm-table");
        ...
        const filterTable = () => {
            ...
            rows.forEach(row => {
                ...
                if (columnIndex && cells[columnIndex]) {
                    ...
                    row.style.display = ""; // Show all rows if no column is selected
                }
            });
        };
